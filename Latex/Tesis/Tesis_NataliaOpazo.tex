...
\vspace{0.5cm} % Da espacio verticales entre lineas 
...
\thispagestyle{empty}
\vspace{5cm}
\hspace{7cm}{\Large\it Dedicado a ... } %\hspace: Espacio Horizontal 
...
\input{./Capitulos_naty/Introduccion.tex}

\chapter{Marco te\'orico (estado del arte)}

\input{./Capitulos_naty/MarcoTeorico.tex}

\chapter{\'Area de Estudio}

\input{./Capitulos_naty/AreaEstudio.tex}

\chapter{Metodolog\'ia}

\input{./Capitulos_naty/Metodologia.tex}

\chapter{Resultados}

\input{./Capitulos_naty/Resultados.tex}

\chapter{Consideraciones finales}

\input{./Capitulos_naty/Discucion.tex}
...
%\begin{quotation}
\input{./Capitulos_naty/Anexos.tex}
